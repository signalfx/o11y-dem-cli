...
For uploading and listing, please ensure that the realm and token are either passed into the command, or set using the environment variables O11Y_REALM and O11Y_TOKEN.
`;
